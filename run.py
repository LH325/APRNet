...
parser.add_argument('--model_id', type=str, required=False, default='APRNet', help='model id')
...
parser.add_argument('--root_path', type=str, default=r'', help='root path of the data file')
...
parser.add_argument('--s1', type=int, default=32, help='Expands the latent representation space before frequency analysis.')
parser.add_argument('--s2', type=int, default=64, help='Expands the predictive function space after frequency reconstruction.')
...
parser.add_argument('--use_kanlinear', default=True, action='store_true')
parser.add_argument('--ETT', default=True,action='store_true')
parser.add_argument('--cross', default=True, action='store_true')
